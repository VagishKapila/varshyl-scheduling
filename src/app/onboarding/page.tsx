  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('/api/onboarding', {
        ...
        body: JSON.stringify({ companyName, logoUrl, footerText }),
      })
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input value={companyName} onChange={e => setCompanyName(e.target.value)}
                ...
                placeholder="Acme Construction Inc." required />
            </div>
            <div>
              <label className="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1">Company Logo</label>
